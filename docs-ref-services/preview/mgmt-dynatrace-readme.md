---
title: 
keywords: Azure, python, SDK, API, azure-mgmt-dynatrace, dynatrace
author: lmazuel
ms.author: lmazuel
ms.date: 02/21/2023
ms.topic: reference
...
Code samples for this package can be found at [Dynatrace Management](/samples/browse/?languages=python&term=Getting%20started%20-%20Managing&terms=Getting%20started%20-%20Managing) on docs.microsoft.com and [Samples Repo](https://aka.ms/azsdk/python/mgmt/samples)
