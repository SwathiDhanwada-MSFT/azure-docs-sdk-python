...
For docs and references, see [Python SDK References](/python/api/overview/azure/relay)
Code samples for this package can be found at [Relay](/samples/browse/?languages=python&term=Getting%20started%20-%20Managing&terms=Getting%20started%20-%20Managing) on docs.microsoft.com.
